      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          ...
          <p style="text-align: center;">
            <a href="http://localhost:8000/auth/verifyemail/${token}" style="display: inline-block; padding: 10px 20px; background-color: #ff5722; color: #fff; text-decoration: none; border-radius: 5px;">
              verify email
            </a>
          </p>
          <p>If the button above doesn't work, you can copy and paste the following link into your browser:</p>
          <p style="word-wrap: break-word;">
            <a href="http://localhost:8000/auth/verifyemail/${token}">
