...
import { Coffee, Beer, TreesIcon as Tree, Sun, Cloud, DollarSign, Briefcase, Home, Users, Car, ThermometerSun } from 'lucide-react'

const benefits = [
  {
    title: "Environmental Stewardship",
    icon: <Tree className="w-10 h-10 text-green-600" />,
    description:
  ...
  },
  {
    ...
    icon: <Beer className="w-10 h-10 text-yellow-600" />,
...
const challenges = [
  ...
  },
  {
    ...
    icon: <ThermometerSun className="w-10 h-10 text-orange-600" />,
    description:
  ...
  return (
    <Card className="h-full overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:cursor-pointer">
      <CardContent className="p-4 bg-gradient-to-br from-white to-gray-50">
        <div className="flex items-center mb-4 transform transition-transform duration-300 group-hover:scale-105">
  ...
  return (
    <div className="min-h-screen mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-center text-gray-900 mb-4 leading-tight">
          Living in Portland, Oregon
        </h1>
        <p className="text-lg text-center mb-6 text-gray-600 leading-relaxed">
          Explore the vibrant tapestry of life in the City of Roses, where urban
          charm meets natural beauty, and discover the unique blend of benefits
          and challenges that shape Portland's distinctive character.
        </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-black text-lg leading-relaxed">
            ...
            challenges. As Portland evolves, it maintains its spirit of
            innovation, environmental consciousness, and community engagement,
            promising a future that honors its past while embracing new
            possibilities.
          </p>
        </section>
      </div>
