...
export default function PortlandOregonPage() {
  return (
    <div className="container mx-auto py-12 space-y-12 mt-[7rem]">
          ...
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Originally inhabited by Native American tribes, including the
                  Multnomah and Clackamas, who utilized the rivers for trade.
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                Portland is known for its progressive values, green initiatives,
                and cultural character—especially in the arts, food, and
            ...
            <div>
              ...
              <p>
                The city is characterized by lush, forested hills, particularly
                in the west. East of the Willamette, the terrain flattens into
                the fertile Willamette Valley.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-2">Natural Boundaries</h3>
              <p>
                The city has an urban growth boundary to control sprawl and
                protect nearby farms and forests, which has helped Portland stay
                compact and green.
              </p>
            </div>
          </CardContent>
      ...
      <section>
        <h2 className="text-3xl font-bold mb-6">Indian Diaspora in Portland</h2>
        <Card>
          <CardContent className="p-6">
            ...
            <ScrollArea className="w-full rounded-md p-2">
              ...
              <Card className="mb-4">
                ...
                <CardContent>
                  <p>
                    <strong>India Cultural Association (ICA):</strong> Organizes
                    major events, including the popular India Festival at
                    Pioneer Courthouse Square, and serves as a community hub.
                  </p>
                </CardContent>
              </Card>
            </ScrollArea>
